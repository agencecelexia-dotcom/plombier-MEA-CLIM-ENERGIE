...
export const metadata: Metadata = generatePageMetadata({
  title: `Chauffage individuel | Chaudière gaz, plancher chauffant — MEA Clim Énergie`,
  description: `Installation et entretien de chauffage individuel par MEA Clim Énergie. Chaudière gaz condensation, plancher chauffant, radiateurs. Certifié RGE. Devis gratuit — ${siteConfig.phone}.`,
  path: "/chauffage",
});

const servicesChauffage = [
  { icon: Flame, title: "Chaudière gaz condensation", desc: "Installation et remplacement de chaudière gaz condensation dernière génération. Jusqu'à 30% d'économies sur votre facture énergétique. Toutes marques : Viessmann, De Dietrich, Vaillant, Chappée.", image: "Chaudiere gaz condensation murale blanche moderne dans buanderie rangee, ecran digital vert, tuyauterie cuivre propre, photo realiste, ratio 3:2", imageKey: "chauffage-chaudiere-gaz" },
  { icon: Wind, title: "Pompe à chaleur air-eau", desc: "Solution écologique et économique pour le chauffage et l'eau chaude sanitaire. Éligible MaPrimeRénov' et CEE. Certifié RGE QualiPAC.", image: "Unite exterieure pompe a chaleur air-eau blanche installee sur terrasse maison individuelle francaise, jardin soigne, photo realiste, ratio 3:2", imageKey: "chauffage-pac" },
  { icon: Heater, title: "Plancher chauffant hydraulique", desc: "Confort thermique optimal et chaleur homogène dans toutes les pièces. Idéal en rénovation complète ou construction neuve.", image: "Installation plancher chauffant en cours, tubes PER rouges en serpentin sur isolant argente, vue plongee, chantier propre, photo realiste, ratio 3:2", imageKey: "chauffage-plancher-chauffant" },
];
...
export default function ChauffagePage() {
  return (
    <ServicePageLayout
      hero={{
        title: "Chauffage individuel — Installation, entretien et dépannage",
        subtitle: "Chaudière gaz condensation, pompe à chaleur, plancher chauffant. Certifié RGE pour bénéficier des aides de l'État.",
        imagePlaceholder: {
    ...
    >
      ...
      <SectionContainer>
        <SectionHeading
          title="Nos solutions de chauffage individuel"
          subtitle="Installation, remplacement et entretien de tous types de systèmes de chauffage. Michel Bernard intervient chez vous sur rendez-vous."
        />
      ...
      <SectionContainer variant="gray">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link href="/climatisation-installation" className="px-8 py-4 border border-neutral-200 text-neutral-700 font-semibold rounded-lg hover:bg-neutral-50 transition-all">Climatisation</Link>
        </div>
      </SectionContainer>
    </ServicePageLayout>
  );
