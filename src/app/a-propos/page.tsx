...
export const metadata: Metadata = generatePageMetadata({
  title: `À propos — ${siteConfig.name} — Michel Bernard`,
  description: `Découvrez MEA Clim Énergie et Michel Bernard, votre installateur climatisation, chauffage et pompe à chaleur depuis ${siteConfig.yearsExperience} ans. Certifié RGE QualiPAC.`,
  path: "/a-propos",
});
...
export default function AProposPage() {
  return (
    <>
      <HeroSection
        variant="page"
        title={`MEA Clim Énergie — Michel Bernard, expert climatisation & chauffage depuis ${siteConfig.yearsExperience} ans`}
        subtitle="Professionnalisme, réactivité et transparence. Certifié RGE QualiPAC."
        imagePlaceholder={{
          prompt: "Technicien spécialiste climatisation en uniforme bleu propre avec logo MEA, installant une unité extérieure sur terrasse maison, souriant, lumière naturelle, photo réaliste, ratio 21:9",
          aspectRatio: "21/9",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Fondée en {siteConfig.foundedYear} par {siteConfig.founder}, MEA Clim Énergie est née d&apos;une passion pour les métiers de la climatisation, du chauffage et de la thermodynamique, et d&apos;une conviction simple : le confort thermique ne doit pas être un luxe.
              </p>
              <p>
                Après {siteConfig.yearsExperience} ans d&apos;expérience et plus de {siteConfig.interventionsCount} installations réalisées, Michel Bernard reste fidèle à ses valeurs : travail soigné, conseils honnêtes, devis respectés. Il intervient pour les particuliers et les professionnels dans le cadre de la climatisation, des pompes à chaleur, du chauffage individuel et de l&apos;eau chaude sanitaire thermodynamique.
              </p>
              <p>
                Certifié RGE QualiPAC et habilité à la manipulation des fluides frigorigènes, Michel Bernard vous accompagne dans toutes vos démarches d&apos;aides à la rénovation énergétique : MaPrimeRénov&apos;, CEE, éco-PTZ.
              </p>
            </div>
          </div>
          <ImagePlaceholder
            prompt="Portrait professionnel technicien frigoriste français, polo bleu MEA Clim Énergie logo brodé, bras croisés, sourire confiant, unités extérieures climatisation en arrière-plan flou, photo réaliste, ratio 2:3"
      ...
      <SectionContainer variant="gray">
        <SectionHeading
          title="Notre équipe"
          subtitle="Des professionnels qualifiés et passionnés à votre service. Climatisation, chauffage, thermodynamique."
        />
        <ImagePlaceholder
          prompt="Technicien climatisation et chauffage en uniforme bleu propre devant camionnette utilitaire blanche avec matériel, souriant, parking extérieur, lumière naturelle, photo réaliste, ratio 3:2"
